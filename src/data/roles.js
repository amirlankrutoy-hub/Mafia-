...
const roles = [
  ...
  },
  {
    ...
    team: 'Мафия',
    image: '/Vor.jpg',
    description: 'Ночной специалист мафии, блокирует голос выбранного игрока на следующем голосовании.',
    ability: 'Блокирует голос игрока. Просыпается сразу после Крёстного отца.'
  },
  {
    id: 'sveshennik',
    name: 'Священник',
